...
public class TourattractionRepositoryImpl implements TourattractionRepositoryCustom{
    ...
    @Override
    public List<String> findPlaceGoogleIdsByAddressAndTourattractionTags(String address, TourattractionTag tourattractionTag) {
        try {
            // Elasticsearch 쿼리 빌드
            SearchRequest searchRequest = SearchRequest.of(s -> s
                    ...
                    .query(q -> q
                            .bool(b -> b
                                    ...
                                    .must(m -> m
                                            .term(t -> t
                                                    .field("tourattractionTags") // 레스토랑 타입 필드명
    ...
    @Override
    public List<String> findPlaceGoogleIdsByAddressAndSubjectiveTags(String address, SubjectiveTag subjectiveTag) {
        try {
            // Elasticsearch 쿼리 빌드
            SearchRequest searchRequest = SearchRequest.of(s -> s
                    .index("places") // 인덱스 이름 (실제 인덱스명으로 변경 필요)
                    .query(q -> q
                            .bool(b -> b
                                    ...
                                    .must(m -> m
                                            .term(t -> t
                                                    .field("subjectiveTags") // 레스토랑 타입 필드명
