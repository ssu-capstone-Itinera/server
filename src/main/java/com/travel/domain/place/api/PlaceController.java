...
public class PlaceController {
    ...
    @PostMapping("/search")
    public ResponseEntity<TourAttractionListDto> searchAttractions(@RequestBody GoogleRequest googleRequest) {
    ...
    public ResponseEntity<List<TourAttractionDetailDto>> searchDetailAttraction(@RequestBody GoogleRequest googleRequest) {
