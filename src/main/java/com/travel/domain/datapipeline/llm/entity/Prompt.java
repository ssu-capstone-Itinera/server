...
public class Prompt {
    public static final String DEFAULT_QUESTION =
            "아래는 장소 리뷰입니다. 각 장소(placeName + 리뷰들)는 {} 안에 있습니다.\n"
                    + "\n"
                    + "당신은 다음 규칙을 반드시 따라야 합니다:\n"
                    + "\n"
                    + "1. 장소 개수(=placeName 수)와 결과 괄호 개수(=() 개수)는 **반드시 1:1로 일치**해야 합니다.\n"
                    ...
                    + "6. 이 규칙을 지키지 않으면 답변은 무효입니다.\n"
                    + "\n"
                    + "사용할 수 있는 태그 목록: [\"활발한\", \"힐링\", \"낭만적인\", \"여유로운\", \"이국적인\", \"전통적인\"]\n"
                    + "\n"
                    + "예시: [(\"활발한\", \"낭만적인\"), (), (\"낭만적인\"), ...]\n"
                    + "\n"
