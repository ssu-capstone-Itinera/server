...
public enum ErrorCode {
    ...
    GOOGLE_API_NO_RESULT(HttpStatus.INTERNAL_SERVER_ERROR, "구글 API 결과가 없습니다"),
    FALLBACK_SEARCH_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "구글 API 결과가 없거나 DB 업데이트에 실패했습니다."),
